...
with open('lib_list_df.csv', 'r') as csv_file:
    ...
    for row in csv_reader:
        ...
        folder_path = f'C:\\Users\\jackb\\OneDrive - Maastricht University\\Jack_MADYMO\\MADYMO_Library\\simulations\\{mph_folder}\\{pass_folder}\\{belt_folder}\\{airbag_folder}\\madymo'
